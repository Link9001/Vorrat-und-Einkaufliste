...
namespace RezepteSammelung.Windows
{
    ...
    {
        private NewOvenSettings(NewOvenSettingsViewModel viewModel)
        {
            InitializeComponent();
            DataContext = viewModel;
        }

        internal static ObservableCollection<OvenSettings> HandelNewOvensettings(NewOvenSettingsViewModel viewModel)
        {
        ...
        {
            NewOvenSettingsViewModel viewModel = (NewOvenSettingsViewModel)DataContext;
